...
class ResNext(nn.Module):
    ...
    def __init__(self, block, layers, num_experts, groups=1, width_per_group=64, dropout=None, num_classes=1000, use_norm=False, reduce_dimension=False, layer3_output_dim=None, layer4_output_dim=None, top_choices_num=5, pos_weight=20, share_ensemble_help_pred_fc=True, force_all=False, s=30):
        self.inplanes = 64
